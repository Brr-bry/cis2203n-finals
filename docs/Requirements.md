...
- **US_04** - As a user, I want to search by book name, so that I can quickly find the section I am looking for.
- **US_05** - As a user, I want to change the font size of the text, so that I can read comfortably based on my preference.
